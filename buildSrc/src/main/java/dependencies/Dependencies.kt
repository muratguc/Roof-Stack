...
object Versions {
    ...
    const val kotlinCoreKtxVersion = "1.5.0-alpha05"
    ...
    const val googleMaterialVersion = "1.3.0-beta01"
    const val constraintLayoutVersion = "2.0.4"
    const val lifeCycleVersion = "2.2.0"
    const val swipeRefreshLayoutVersion = "1.2.0-alpha01"
...
object Libraries {
    ...
    const val chuckerdebug = "com.github.chuckerteam.chucker:library:3.4.0"
    const val chuckerrelease = "com.github.chuckerteam.chucker:library-no-op:3.4.0"
